...
@section('title', 'Update Tank Order Delivery')
@section('content')
<style>
                        ...
                        <div class="col-12 col-lg-8 m-auto">
                            <div class="card">
                                ...
                                @if(session('error'))
                                    ...
                                    @endif
                                    <form method="POST" action="{{ route('tankdelivery.update') }}">

                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" value="{{ $data->id }}" name="id">
                                        <input type="hidden" value="{{ $data->do_volume }}" name="do_volume_lama">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="input-group input-group-static ">
                                                            ...
                                                            <input
                                                                ...
                                                                name="id_don" id="id_don" value="{{ $data->id_don }}"
                                                    ...
                                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                        <div class="input-group input-group-static">
                                                            ...
                                                            <input
                                                                ...
                                                                name="driver" id="driver" value="{{ $data->driver }}"
                                                                type="text" onfocus="focused(this)"
                                                                onfocusout="defocused(this)" required>
                                                            @error('driver')
                                                                <span class="invalid-feedback">{{ $message }}</span>
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="input-group input-group-static ">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ $data->vehicle_number }}" type="text"
                                                        ...
                                                        <div class="input-group input-group-static">
                                                            ...
                                                            <select class="form-control" id="id_supplier" name="id_supplier"
                                                                ...
                                                                @foreach ($supplier as $t)
                                                                    <option value="{{ $t->id }}"
                                                                        {{ $data->id_supplier == $t->id ? 'selected' : '' }}>
                                                                        {{ $t->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="input-group input-group-static ">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ $data->do_volume }}" type="number"
                                                                onfocus="focused(this)" onfocusout="defocused(this)"
                                                                required>
                                                            @error('do_volume')
                                                                <span class="invalid-feedback">{{ $message }}</span>
